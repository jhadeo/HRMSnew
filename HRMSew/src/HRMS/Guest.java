 ...
 */
public class Guest {
    public static String getGuestString() throws SQLException{
        int id=0;
    ...
    public static boolean AddGuest(String first, String middle, String last, String mobile, String email, String home, Date sqlDate, String gender, int status) throws SQLException{
